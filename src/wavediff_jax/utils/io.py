...
manage wavediff-jax inputs and outputs.

Ported from wf-psf (CosmoStat/wf-psf) to wavediff-jax.
Original author: Jennifer Pollack <jennifer.pollack@cea.fr>
...
class FileIOHandler:
    ...
    def _setup_logging(self):
        ...
        A function to set up logging using
        basic logging configuration.

        """
        logfile = "wavediff-jax_" + self._timestamp + ".log"
