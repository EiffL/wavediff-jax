...
Original author: Tobias Liaudat <tobias.liaudat@cea.fr>
...
from wavediff_jax.utils.preprocessing import defocus_to_zk4_wavediff
...
class CCDMisalignmentCalculator:
    ...
    The `tiles_data` array is a data cube where each slice is a 4x3 matrix representing
    the four corners of a tile. The first two columns correspond to x/y coordinates (in mm),
    and the third column represents z displacement (in um).
